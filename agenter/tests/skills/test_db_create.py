...
"""Tests for the `db-create` skill.

Auto-generated stub. Fill in fixtures and assertions following
the patterns in `tests/skills/test_subsystem_edit.py`.

Source: `.claude/skills/db-create/SKILL.md`
Entry kind: ps1
Entry script: `.claude/skills/db-create/scripts/db-create.ps1`
"""
...
def test_skill_script_exists(skills_dir: Path):
    """A PowerShell entry point named `db-create.ps1` should exist."""
    script = skills_dir / "db-create" / "scripts" / "db-create.ps1"
