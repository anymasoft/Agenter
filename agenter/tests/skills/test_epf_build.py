...
"""Tests for the `epf-build` skill.

Auto-generated stub. Fill in fixtures and assertions following
the patterns in `tests/skills/test_subsystem_edit.py`.

Source: `.claude/skills/epf-build/SKILL.md`
Entry kind: ps1
Entry script: `.claude/skills/epf-build/scripts/epf-build.ps1`
"""
...
def test_skill_script_exists(skills_dir: Path):
    """A PowerShell entry point named `epf-build.ps1` should exist."""
    script = skills_dir / "epf-build" / "scripts" / "epf-build.ps1"
