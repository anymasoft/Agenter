...
"""Tests for the `cf-init` skill.

Auto-generated stub. Fill in fixtures and assertions following
the patterns in `tests/skills/test_subsystem_edit.py`.

Source: `.claude/skills/cf-init/SKILL.md`
Entry kind: ps1
Entry script: `.claude/skills/cf-init/scripts/cf-init.ps1`
"""
...
def test_skill_script_exists(skills_dir: Path):
    """A PowerShell entry point named `cf-init.ps1` should exist."""
    script = skills_dir / "cf-init" / "scripts" / "cf-init.ps1"
