...
"""Tests for the `meta-remove` skill.

Auto-generated stub. Fill in fixtures and assertions following
the patterns in `tests/skills/test_subsystem_edit.py`.

Source: `.claude/skills/meta-remove/SKILL.md`
Entry kind: ps1
Entry script: `.claude/skills/meta-remove/scripts/meta-remove.ps1`
"""
...
def test_skill_script_exists(skills_dir: Path):
    """A PowerShell entry point named `meta-remove.ps1` should exist."""
    script = skills_dir / "meta-remove" / "scripts" / "meta-remove.ps1"
