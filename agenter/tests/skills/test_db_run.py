...
"""Tests for the `db-run` skill.

Auto-generated stub. Fill in fixtures and assertions following
the patterns in `tests/skills/test_subsystem_edit.py`.

Source: `.claude/skills/db-run/SKILL.md`
Entry kind: ps1
Entry script: `.claude/skills/db-run/scripts/db-run.ps1`
"""
...
def test_skill_script_exists(skills_dir: Path):
    """A PowerShell entry point named `db-run.ps1` should exist."""
    script = skills_dir / "db-run" / "scripts" / "db-run.ps1"
