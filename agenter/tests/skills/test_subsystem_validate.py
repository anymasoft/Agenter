...
"""Tests for the `subsystem-validate` skill.

Auto-generated stub. Fill in fixtures and assertions following
the patterns in `tests/skills/test_subsystem_edit.py`.

Source: `.claude/skills/subsystem-validate/SKILL.md`
Entry kind: ps1
Entry script: `.claude/skills/subsystem-validate/scripts/subsystem-validate.ps1`
"""
...
def test_skill_script_exists(skills_dir: Path):
    """A PowerShell entry point named `subsystem-validate.ps1` should exist."""
    script = skills_dir / "subsystem-validate" / "scripts" / "subsystem-validate.ps1"
