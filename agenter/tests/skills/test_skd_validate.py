...
"""Tests for the `skd-validate` skill.

Auto-generated stub. Fill in fixtures and assertions following
the patterns in `tests/skills/test_subsystem_edit.py`.

Source: `.claude/skills/skd-validate/SKILL.md`
Entry kind: ps1
Entry script: `.claude/skills/skd-validate/scripts/skd-validate.ps1`
"""
...
def test_skill_script_exists(skills_dir: Path):
    """A PowerShell entry point named `skd-validate.ps1` should exist."""
    script = skills_dir / "skd-validate" / "scripts" / "skd-validate.ps1"
