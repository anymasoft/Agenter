...
"""Tests for the `meta-info` skill.

Auto-generated stub. Fill in fixtures and assertions following
the patterns in `tests/skills/test_subsystem_edit.py`.

Source: `.claude/skills/meta-info/SKILL.md`
Entry kind: ps1
Entry script: `.claude/skills/meta-info/scripts/meta-info.ps1`
"""
...
def test_skill_script_exists(skills_dir: Path):
    """A PowerShell entry point named `meta-info.ps1` should exist."""
    script = skills_dir / "meta-info" / "scripts" / "meta-info.ps1"
