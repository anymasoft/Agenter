...
"""Tests for the `form-edit` skill.

Auto-generated stub. Fill in fixtures and assertions following
the patterns in `tests/skills/test_subsystem_edit.py`.

Source: `.claude/skills/form-edit/SKILL.md`
Entry kind: ps1
Entry script: `.claude/skills/form-edit/scripts/form-edit.ps1`
"""
...
def test_skill_script_exists(skills_dir: Path):
    """A PowerShell entry point named `form-edit.ps1` should exist."""
    script = skills_dir / "form-edit" / "scripts" / "form-edit.ps1"
