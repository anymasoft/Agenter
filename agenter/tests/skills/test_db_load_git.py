...
"""Tests for the `db-load-git` skill.

Auto-generated stub. Fill in fixtures and assertions following
the patterns in `tests/skills/test_subsystem_edit.py`.

Source: `.claude/skills/db-load-git/SKILL.md`
Entry kind: ps1
Entry script: `.claude/skills/db-load-git/scripts/db-load-git.ps1`
"""
...
def test_skill_script_exists(skills_dir: Path):
    """A PowerShell entry point named `db-load-git.ps1` should exist."""
    script = skills_dir / "db-load-git" / "scripts" / "db-load-git.ps1"
