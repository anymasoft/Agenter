...
"""Tests for the `web-publish` skill.

Auto-generated stub. Fill in fixtures and assertions following
the patterns in `tests/skills/test_subsystem_edit.py`.

Source: `.claude/skills/web-publish/SKILL.md`
Entry kind: ps1
Entry script: `.claude/skills/web-publish/scripts/web-publish.ps1`
"""
...
def test_skill_script_exists(skills_dir: Path):
    """A PowerShell entry point named `web-publish.ps1` should exist."""
    script = skills_dir / "web-publish" / "scripts" / "web-publish.ps1"
