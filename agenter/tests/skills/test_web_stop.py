...
"""Tests for the `web-stop` skill.

Auto-generated stub. Fill in fixtures and assertions following
the patterns in `tests/skills/test_subsystem_edit.py`.

Source: `.claude/skills/web-stop/SKILL.md`
Entry kind: ps1
Entry script: `.claude/skills/web-stop/scripts/web-stop.ps1`
"""
...
def test_skill_script_exists(skills_dir: Path):
    """A PowerShell entry point named `web-stop.ps1` should exist."""
    script = skills_dir / "web-stop" / "scripts" / "web-stop.ps1"
