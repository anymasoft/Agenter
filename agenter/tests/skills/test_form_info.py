...
"""Tests for the `form-info` skill.

Auto-generated stub. Fill in fixtures and assertions following
the patterns in `tests/skills/test_subsystem_edit.py`.

Source: `.claude/skills/form-info/SKILL.md`
Entry kind: ps1
Entry script: `.claude/skills/form-info/scripts/form-info.ps1`
"""
...
def test_skill_script_exists(skills_dir: Path):
    """A PowerShell entry point named `form-info.ps1` should exist."""
    script = skills_dir / "form-info" / "scripts" / "form-info.ps1"
