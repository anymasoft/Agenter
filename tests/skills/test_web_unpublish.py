...
"""Tests for the `web-unpublish` skill.

Auto-generated stub. Fill in fixtures and assertions following
the patterns in `tests/skills/test_subsystem_edit.py`.

Source: `.claude/skills/web-unpublish/SKILL.md`
Entry kind: ps1
Entry script: `.claude/skills/web-unpublish/scripts/web-unpublish.ps1`
"""
...
def test_skill_script_exists(skills_dir: Path):
    """A PowerShell entry point named `web-unpublish.ps1` should exist."""
    script = skills_dir / "web-unpublish" / "scripts" / "web-unpublish.ps1"
