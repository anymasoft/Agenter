...
"""Tests for the `prd-create` skill.

Auto-generated stub. Fill in fixtures and assertions following
the patterns in `tests/skills/test_subsystem_edit.py`.

Source: `.claude/skills/prd-create/SKILL.md`
Entry kind: py
Entry script: `.claude/skills/prd-create/scripts/prd-create.py`
"""
...
def test_skill_script_exists(skills_dir: Path):
    """A Python entry point named `prd-create.py` should exist."""
    script = skills_dir / "prd-create" / "scripts" / "prd-create.py"
