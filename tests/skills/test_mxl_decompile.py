...
"""Tests for the `mxl-decompile` skill.

Auto-generated stub. Fill in fixtures and assertions following
the patterns in `tests/skills/test_subsystem_edit.py`.

Source: `.claude/skills/mxl-decompile/SKILL.md`
Entry kind: ps1
Entry script: `.claude/skills/mxl-decompile/scripts/mxl-decompile.ps1`
"""
...
def test_skill_script_exists(skills_dir: Path):
    """A PowerShell entry point named `mxl-decompile.ps1` should exist."""
    script = skills_dir / "mxl-decompile" / "scripts" / "mxl-decompile.ps1"
