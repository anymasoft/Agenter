...
"""Tests for the `erf-init` skill.

Auto-generated stub. Fill in fixtures and assertions following
the patterns in `tests/skills/test_subsystem_edit.py`.

Source: `.claude/skills/erf-init/SKILL.md`
Entry kind: ps1
Entry script: `.claude/skills/erf-init/scripts/init.ps1`
"""
...
def test_skill_script_exists(skills_dir: Path):
    ...
    script = skills_dir / "erf-init" / "scripts" / "init.ps1"
